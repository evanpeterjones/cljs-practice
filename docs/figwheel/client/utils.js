...
return (new CustomEvent(event_name,(function (){var obj24263 = ({"detail":data});
return obj24263;
})()));
} else {
...
var f = (function (){var pred__24270 = cljs.core._EQ_;
var expr__24271 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__24270.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__24271))){
return (function (p1__24264_SHARP_){
return console.warn(p1__24264_SHARP_);
});
} else {
if(cljs.core.truth_(pred__24270.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__24271))){
return (function (p1__24265_SHARP_){
return console.debug(p1__24265_SHARP_);
});
} else {
if(cljs.core.truth_(pred__24270.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__24271))){
return (function (p1__24266_SHARP_){
return console.error(p1__24266_SHARP_);
});
} else {
return (function (p1__24267_SHARP_){
return console.log(p1__24267_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__24274){
...
var eval_fn = cljs.core.get.call(null,map__24275__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__24277_SHARP_){
return new_def.callback(p1__24277_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__24278){
var vec__24279 = p__24278;
var ky = cljs.core.nth.call(null,vec__24279,(0),null);
...
}catch (e24284){if((e24284 instanceof Error)){
var e = e24284;
return not_found;
} else {
throw e24284;
...
//# sourceMappingURL=utils.js.map?rel=1607231746366
