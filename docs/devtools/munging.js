...
var o24963 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24963["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24964 = temp__5718__auto____$1;
return (o24964["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24321__auto__ = f;
return (o__24321__auto__["toString"]).call(o__24321__auto__);
} else {
return "";
}
}catch (e24965){var _ = e24965;
return "";
}});
...
try{var o__24321__auto___24967 = t;
(o__24321__auto___24967["cljs$lang$ctorPrWriter"]).call(o__24321__auto___24967,t,writer);
}catch (e24966){var __24968 = e24966;
}
...
var char_code = (function (){var o__24321__auto__ = (new String(char$));
return (o__24321__auto__["charCodeAt"]).call(o__24321__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24321__auto__ = String;
return (o__24321__auto__["fromCharCode"]).call(o__24321__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24969 = num_code;
switch (G__24969) {
case (1):
return (185);
...
var o__24321__auto__ = String;
return (o__24321__auto__["fromCharCode"]).call(o__24321__auto__,superscript_code);
});
/**
...
}catch (e24971){var _e__24328__auto__ = e24971;
return false;
}})())){
...
var vec__24972 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24972,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o24975 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24975["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24976 = temp__5718__auto____$1;
return (o24976["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24979){
var vec__24980 = p__24979;
var ns_detector = cljs.core.nth.call(null,vec__24980,(0),null);
...
var G__24986 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24987 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24986;
remaining_tokens = G__24987;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24977){
...
var vec__24991 = cljs.core.split_with.call(null,(function (p1__24990_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24990_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24991,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24991,(1),null);
...
var vec__24997 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24997,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24997,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25000 = cljs.core.rest.call(null,remaining_tokens);
var G__25001 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25000;
name_tokens = G__25001;
continue;
} else {
...
var vec__25004 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25004,(0),null);
var arity = cljs.core.nth.call(null,vec__25004,(1),null);
var vec__25007 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25007,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25007,(1),null);
var vec__25010 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25010,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25010,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25010,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25010,(3),null);
...
var vec__25016 = result;
var munged_ns = cljs.core.nth.call(null,vec__25016,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25016,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25016,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25016,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25016,(4),null);
var arity = cljs.core.nth.call(null,vec__25016,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__25020 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__25020,(0),null);
var args = cljs.core.nth.call(null,vec__25020,(1),null);
var vec__25023 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25023,(0),null);
var name = cljs.core.nth.call(null,vec__25023,(1),null);
...
var G__25026 = (arity + (1));
var G__25027 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25028){
var vec__25029 = p__25028;
var arity = cljs.core.nth.call(null,vec__25029,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25029,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25032_SHARP_){
return cljs.core.get.call(null,arities,p1__25032_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__25033_SHARP_){
return cljs.core.drop.call(null,(2),p1__25033_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25036){
var vec__25037 = p__25036;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25037,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25034){
var G__25035 = cljs.core.first.call(null,seq25034);
var seq25034__$1 = cljs.core.next.call(null,seq25034);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25035,seq25034__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25045__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25045__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25045__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25045__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25046 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25046,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25046,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25046,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25046,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25046,(4),null);
var arity = cljs.core.nth.call(null,vec__25046,(5),null);
...
var o__24321__auto__ = f;
return (o__24321__auto__["getBasis"]).call(o__24321__auto__);
});
/**
...
}catch (e25050){var _e__24328__auto__ = e25050;
...
var G__25051 = (obj[cljs.core.first.call(null,path)]);
var G__25052 = cljs.core.rest.call(null,path);
obj = G__25051;
path = G__25052;
continue;
} else {
...
var _STAR_ = (function (accum,p__25053){
var vec__25054 = p__25053;
var bit = cljs.core.nth.call(null,vec__25054,(0),null);
var protocol = cljs.core.nth.call(null,vec__25054,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25057){
var vec__25058 = p__25057;
var ns = cljs.core.nth.call(null,vec__25058,(0),null);
var name = cljs.core.nth.call(null,vec__25058,(1),null);
var selector = cljs.core.nth.call(null,vec__25058,(2),null);
...
var post_process = (function (p__25062){
var vec__25063 = p__25062;
var munged_name = cljs.core.nth.call(null,vec__25063,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25063,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25061_SHARP_){
return (obj[cljs.core.first.call(null,p1__25061_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1607231746888
