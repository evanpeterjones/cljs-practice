...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_21262 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_21262.call(null,this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_21263 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_21263.call(null,this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_21264 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_21264.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_21265 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_21265.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_21266 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_21266.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_21267 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_21267.call(null,this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_21268 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_21268.call(null,this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_21269 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_21269.call(null,this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_21270 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_21270.call(null,this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_21271 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_21271.call(null,this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k21273,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k21273,else__4383__auto__);
...
return cljs.core.reduce.call(null,(function (ret__4402__auto__,p__21278){
var vec__21279 = p__21278;
var k__4403__auto__ = cljs.core.nth.call(null,vec__21279,(0),null);
var v__4404__auto__ = cljs.core.nth.call(null,vec__21279,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21272){
var self__ = this;
var G__21272__$1 = this;
return (new cljs.core.RecordIter((0),G__21272__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this21274,other21275){
var self__ = this;
var this21274__$1 = this;
return (((!((other21275 == null)))) && ((this21274__$1.constructor === other21275.constructor)) && (cljs.core._EQ_.call(null,this21274__$1.status,other21275.status)) && (cljs.core._EQ_.call(null,this21274__$1.body,other21275.body)) && (cljs.core._EQ_.call(null,this21274__$1.status_text,other21275.status_text)) && (cljs.core._EQ_.call(null,this21274__$1.headers,other21275.headers)) && (cljs.core._EQ_.call(null,this21274__$1.was_aborted,other21275.was_aborted)) && (cljs.core._EQ_.call(null,this21274__$1.__extmap,other21275.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__21272){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__21282 = cljs.core.keyword_identical_QMARK_;
var expr__21283 = k__4388__auto__;
if(cljs.core.truth_(pred__21282.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__21283))){
return (new ajax.protocols.Response(G__21272,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__21282.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__21283))){
return (new ajax.protocols.Response(self__.status,G__21272,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__21282.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__21283))){
return (new ajax.protocols.Response(self__.status,self__.body,G__21272,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__21282.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__21283))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__21272,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__21282.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__21283))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__21272,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4388__auto__,G__21272),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__21272){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__21272,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__21276){
var extmap__4419__auto__ = (function (){var G__21285 = cljs.core.dissoc.call(null,G__21276,new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828));
if(cljs.core.record_QMARK_.call(null,G__21276)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__21285);
} else {
return G__21285;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__21276),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__21276),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__21276),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__21276),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__21276),null,cljs.core.not_empty.call(null,extmap__4419__auto__),null));
});


//# sourceMappingURL=protocols.js.map?rel=1607132425461
