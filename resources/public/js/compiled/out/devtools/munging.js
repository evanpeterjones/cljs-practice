...
var o23297 = temp__5718__auto__;
var temp__5718__auto____$1 = (o23297["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o23298 = temp__5718__auto____$1;
return (o23298["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22655__auto__ = f;
return (o__22655__auto__["toString"]).call(o__22655__auto__);
} else {
return "";
}
}catch (e23299){var _ = e23299;
return "";
}});
...
try{var o__22655__auto___23301 = t;
(o__22655__auto___23301["cljs$lang$ctorPrWriter"]).call(o__22655__auto___23301,t,writer);
}catch (e23300){var __23302 = e23300;
}
...
var char_code = (function (){var o__22655__auto__ = (new String(char$));
return (o__22655__auto__["charCodeAt"]).call(o__22655__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22655__auto__ = String;
return (o__22655__auto__["fromCharCode"]).call(o__22655__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23303 = num_code;
switch (G__23303) {
case (1):
return (185);
...
var o__22655__auto__ = String;
return (o__22655__auto__["fromCharCode"]).call(o__22655__auto__,superscript_code);
});
/**
...
}catch (e23305){var _e__22662__auto__ = e23305;
return false;
}})())){
...
var vec__23306 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23306,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o23309 = temp__5718__auto__;
var temp__5718__auto____$1 = (o23309["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o23310 = temp__5718__auto____$1;
return (o23310["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23313){
var vec__23314 = p__23313;
var ns_detector = cljs.core.nth.call(null,vec__23314,(0),null);
...
var G__23320 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23321 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23320;
remaining_tokens = G__23321;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23311){
var G__23312 = cljs.core.first.call(null,seq23311);
var seq23311__$1 = cljs.core.next.call(null,seq23311);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23312,seq23311__$1);
}));
...
var vec__23325 = cljs.core.split_with.call(null,(function (p1__23324_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23324_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23325,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23325,(1),null);
...
var vec__23331 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23331,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23331,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23334 = cljs.core.rest.call(null,remaining_tokens);
var G__23335 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23334;
name_tokens = G__23335;
continue;
} else {
...
var vec__23338 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23338,(0),null);
var arity = cljs.core.nth.call(null,vec__23338,(1),null);
var vec__23341 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23341,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23341,(1),null);
var vec__23344 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23344,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23344,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23344,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23344,(3),null);
...
var vec__23350 = result;
var munged_ns = cljs.core.nth.call(null,vec__23350,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23350,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23350,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23350,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23350,(4),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__23354 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__23354,(0),null);
var args = cljs.core.nth.call(null,vec__23354,(1),null);
var vec__23357 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23357,(0),null);
var name = cljs.core.nth.call(null,vec__23357,(1),null);
...
var G__23360 = (arity + (1));
var G__23361 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23362){
var vec__23363 = p__23362;
var arity = cljs.core.nth.call(null,vec__23363,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23363,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23366_SHARP_){
return cljs.core.get.call(null,arities,p1__23366_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__23367_SHARP_){
return cljs.core.drop.call(null,(2),p1__23367_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___23374 = arguments.length;
var i__4737__auto___23375 = (0);
while(true){
if((i__4737__auto___23375 < len__4736__auto___23374)){
args__4742__auto__.push((arguments[i__4737__auto___23375]));

var G__23376 = (i__4737__auto___23375 + (1));
i__4737__auto___23375 = G__23376;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23370){
var vec__23371 = p__23370;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23371,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23368){
var G__23369 = cljs.core.first.call(null,seq23368);
var seq23368__$1 = cljs.core.next.call(null,seq23368);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23369,seq23368__$1);
}));
...
var map__23379 = options;
var map__23379__$1 = (((((!((map__23379 == null))))?(((((map__23379.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23379.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23379):map__23379);
var include_ns_QMARK_ = cljs.core.get.call(null,map__23379__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23379__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23379__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23379__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23380 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23380,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23380,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23380,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23380,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23380,(4),null);
var arity = cljs.core.nth.call(null,vec__23380,(5),null);
...
var o__22655__auto__ = f;
return (o__22655__auto__["getBasis"]).call(o__22655__auto__);
});
/**
...
}catch (e23384){var _e__22662__auto__ = e23384;
...
var G__23385 = (obj[cljs.core.first.call(null,path)]);
var G__23386 = cljs.core.rest.call(null,path);
obj = G__23385;
path = G__23386;
continue;
} else {
...
var _STAR_ = (function (accum,p__23387){
var vec__23388 = p__23387;
var bit = cljs.core.nth.call(null,vec__23388,(0),null);
var protocol = cljs.core.nth.call(null,vec__23388,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23391){
var vec__23392 = p__23391;
var ns = cljs.core.nth.call(null,vec__23392,(0),null);
var name = cljs.core.nth.call(null,vec__23392,(1),null);
var selector = cljs.core.nth.call(null,vec__23392,(2),null);
...
var post_process = (function (p__23396){
var vec__23397 = p__23396;
var munged_name = cljs.core.nth.call(null,vec__23397,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23397,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23395_SHARP_){
return (obj[cljs.core.first.call(null,p1__23395_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1607132429590
