...
return (new CustomEvent(event_name,(function (){var obj24227 = ({"detail":data});
return obj24227;
})()));
} else {
...
var f = (function (){var pred__24234 = cljs.core._EQ_;
var expr__24235 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__24234.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__24235))){
return (function (p1__24228_SHARP_){
return console.warn(p1__24228_SHARP_);
});
} else {
if(cljs.core.truth_(pred__24234.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__24235))){
return (function (p1__24229_SHARP_){
return console.debug(p1__24229_SHARP_);
});
} else {
if(cljs.core.truth_(pred__24234.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__24235))){
return (function (p1__24230_SHARP_){
return console.error(p1__24230_SHARP_);
});
} else {
return (function (p1__24231_SHARP_){
return console.log(p1__24231_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__24238){
...
var opts = map__24239__$1;
var eval_fn = cljs.core.get.call(null,map__24239__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__24241_SHARP_){
return new_def.callback(p1__24241_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__24242){
var vec__24243 = p__24242;
var ky = cljs.core.nth.call(null,vec__24243,(0),null);
var v = cljs.core.nth.call(null,vec__24243,(1),null);
...
}catch (e24248){if((e24248 instanceof Error)){
var e = e24248;
return not_found;
} else {
throw e24248;
...
//# sourceMappingURL=utils.js.map?rel=1605638682499
