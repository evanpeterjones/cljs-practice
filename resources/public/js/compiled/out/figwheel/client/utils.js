...
return (new CustomEvent(event_name,(function (){var obj37295 = ({"detail":data});
return obj37295;
})()));
} else {
...
var f = (function (){var pred__37302 = cljs.core._EQ_;
var expr__37303 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37302.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37303))){
return (function (p1__37296_SHARP_){
return console.warn(p1__37296_SHARP_);
});
} else {
if(cljs.core.truth_(pred__37302.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37303))){
return (function (p1__37297_SHARP_){
return console.debug(p1__37297_SHARP_);
});
} else {
if(cljs.core.truth_(pred__37302.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37303))){
return (function (p1__37298_SHARP_){
return console.error(p1__37298_SHARP_);
});
} else {
return (function (p1__37299_SHARP_){
return console.log(p1__37299_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37306){
...
var eval_fn = cljs.core.get.call(null,map__37307__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__37309_SHARP_){
return new_def.callback(p1__37309_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__37310){
var vec__37311 = p__37310;
var ky = cljs.core.nth.call(null,vec__37311,(0),null);
var v = cljs.core.nth.call(null,vec__37311,(1),null);
...
}catch (e37316){if((e37316 instanceof Error)){
var e = e37316;
return not_found;
} else {
throw e37316;
...
//# sourceMappingURL=utils.js.map?rel=1607284884665
