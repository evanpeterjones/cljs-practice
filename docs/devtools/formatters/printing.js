...
var len__4736__auto___25097 = arguments.length;
var i__4737__auto___25098 = (0);
while(true){
if((i__4737__auto___25098 < len__4736__auto___25097)){
args__4742__auto__.push((arguments[i__4737__auto___25098]));

var G__25099 = (i__4737__auto___25098 + (1));
i__4737__auto___25098 = G__25099;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq25094){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25095,G__25096,seq25094__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__25100_SHARP_){
return (!((cljs.core.meta.call(null,p1__25100_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__25101__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e25105){var _e__24328__auto__ = e25105;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e25107){var _e__24328__auto__ = e25107;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__25109 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__25110 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__25110);

try{var map__25111 = opts;
...
var markup_db = cljs.core.get.call(null,map__25111__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__25109);
}});
...
var temp__5718__auto___25116 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___25116)){
var managed_print_level_25117 = temp__5718__auto___25116;
var _STAR_print_level_STAR__orig_val__25114_25118 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__25115_25119 = managed_print_level_25117;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__25115_25119);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__25113_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__25113_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__25114_25118);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1607231747025
