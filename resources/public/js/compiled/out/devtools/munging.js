...
var o24927 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24927["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24928 = temp__5718__auto____$1;
return (o24928["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24285__auto__ = f;
return (o__24285__auto__["toString"]).call(o__24285__auto__);
} else {
return "";
}
}catch (e24929){var _ = e24929;
return "";
}});
...
try{var o__24285__auto___24931 = t;
(o__24285__auto___24931["cljs$lang$ctorPrWriter"]).call(o__24285__auto___24931,t,writer);
}catch (e24930){var __24932 = e24930;
}
...
var char_code = (function (){var o__24285__auto__ = (new String(char$));
return (o__24285__auto__["charCodeAt"]).call(o__24285__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24285__auto__ = String;
return (o__24285__auto__["fromCharCode"]).call(o__24285__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24933 = num_code;
switch (G__24933) {
case (1):
return (185);
...
var o__24285__auto__ = String;
return (o__24285__auto__["fromCharCode"]).call(o__24285__auto__,superscript_code);
});
/**
...
}catch (e24935){var _e__24292__auto__ = e24935;
return false;
}})())){
...
var vec__24936 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24936,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o24939 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24939["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24940 = temp__5718__auto____$1;
return (o24940["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24943){
var vec__24944 = p__24943;
var ns_detector = cljs.core.nth.call(null,vec__24944,(0),null);
...
var G__24950 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24951 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24950;
remaining_tokens = G__24951;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24941){
var G__24942 = cljs.core.first.call(null,seq24941);
var seq24941__$1 = cljs.core.next.call(null,seq24941);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24942,seq24941__$1);
}));
...
var vec__24955 = cljs.core.split_with.call(null,(function (p1__24954_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24954_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24955,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24955,(1),null);
...
var vec__24961 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24961,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24961,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24964 = cljs.core.rest.call(null,remaining_tokens);
var G__24965 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24964;
name_tokens = G__24965;
continue;
} else {
...
var vec__24968 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24968,(0),null);
var arity = cljs.core.nth.call(null,vec__24968,(1),null);
var vec__24971 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24971,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24971,(1),null);
var vec__24974 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__24974,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__24974,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__24974,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__24974,(3),null);
...
var vec__24980 = result;
var munged_ns = cljs.core.nth.call(null,vec__24980,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__24980,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__24980,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__24980,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__24980,(4),null);
var arity = cljs.core.nth.call(null,vec__24980,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__24984 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__24984,(0),null);
var args = cljs.core.nth.call(null,vec__24984,(1),null);
var vec__24987 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__24987,(0),null);
var name = cljs.core.nth.call(null,vec__24987,(1),null);
...
var G__24990 = (arity + (1));
var G__24991 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24992){
var vec__24993 = p__24992;
var arity = cljs.core.nth.call(null,vec__24993,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24993,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__24996_SHARP_){
return cljs.core.get.call(null,arities,p1__24996_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__24997_SHARP_){
return cljs.core.drop.call(null,(2),p1__24997_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25000){
var vec__25001 = p__25000;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25001,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24998){
var G__24999 = cljs.core.first.call(null,seq24998);
var seq24998__$1 = cljs.core.next.call(null,seq24998);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24999,seq24998__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__25009__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25009__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25009__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25009__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25010 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25010,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25010,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25010,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25010,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25010,(4),null);
var arity = cljs.core.nth.call(null,vec__25010,(5),null);
...
var o__24285__auto__ = f;
return (o__24285__auto__["getBasis"]).call(o__24285__auto__);
});
/**
...
}catch (e25014){var _e__24292__auto__ = e25014;
...
var G__25015 = (obj[cljs.core.first.call(null,path)]);
var G__25016 = cljs.core.rest.call(null,path);
obj = G__25015;
path = G__25016;
continue;
} else {
...
var _STAR_ = (function (accum,p__25017){
var vec__25018 = p__25017;
var bit = cljs.core.nth.call(null,vec__25018,(0),null);
var protocol = cljs.core.nth.call(null,vec__25018,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25021){
...
var selector = cljs.core.nth.call(null,vec__25022,(2),null);
...
var post_process = (function (p__25026){
var vec__25027 = p__25026;
var munged_name = cljs.core.nth.call(null,vec__25027,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25027,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25025_SHARP_){
return (obj[cljs.core.first.call(null,p1__25025_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1605638683010
