...
var o24954 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24954["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24955 = temp__5718__auto____$1;
return (o24955["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24312__auto__ = f;
return (o__24312__auto__["toString"]).call(o__24312__auto__);
} else {
return "";
}
}catch (e24956){var _ = e24956;
return "";
}});
...
try{var o__24312__auto___24958 = t;
(o__24312__auto___24958["cljs$lang$ctorPrWriter"]).call(o__24312__auto___24958,t,writer);
}catch (e24957){var __24959 = e24957;
}
...
var char_code = (function (){var o__24312__auto__ = (new String(char$));
return (o__24312__auto__["charCodeAt"]).call(o__24312__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24312__auto__ = String;
return (o__24312__auto__["fromCharCode"]).call(o__24312__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__24960 = num_code;
switch (G__24960) {
case (1):
return (185);
...
var o__24312__auto__ = String;
return (o__24312__auto__["fromCharCode"]).call(o__24312__auto__,superscript_code);
});
/**
...
}catch (e24962){var _e__24319__auto__ = e24962;
return false;
}})())){
...
var vec__24963 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__24963,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o24966 = temp__5718__auto__;
var temp__5718__auto____$1 = (o24966["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o24967 = temp__5718__auto____$1;
return (o24967["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___24974 = arguments.length;
var i__4737__auto___24975 = (0);
while(true){
if((i__4737__auto___24975 < len__4736__auto___24974)){
args__4742__auto__.push((arguments[i__4737__auto___24975]));

var G__24976 = (i__4737__auto___24975 + (1));
i__4737__auto___24975 = G__24976;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__24970){
var vec__24971 = p__24970;
var ns_detector = cljs.core.nth.call(null,vec__24971,(0),null);
...
var G__24977 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__24978 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__24977;
remaining_tokens = G__24978;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq24968){
...
var vec__24982 = cljs.core.split_with.call(null,(function (p1__24981_SHARP_){
return cljs.core.not_EQ_.call(null,p1__24981_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__24982,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__24982,(1),null);
...
var vec__24988 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__24988,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__24988,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__24991 = cljs.core.rest.call(null,remaining_tokens);
var G__24992 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__24991;
name_tokens = G__24992;
continue;
} else {
...
var vec__24995 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__24995,(0),null);
var arity = cljs.core.nth.call(null,vec__24995,(1),null);
var vec__24998 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__24998,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__24998,(1),null);
var vec__25001 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25001,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25001,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25001,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25001,(3),null);
...
var vec__25007 = result;
var munged_ns = cljs.core.nth.call(null,vec__25007,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25007,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25007,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25007,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25007,(4),null);
var arity = cljs.core.nth.call(null,vec__25007,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__25011 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__25011,(0),null);
var args = cljs.core.nth.call(null,vec__25011,(1),null);
var vec__25014 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25014,(0),null);
var name = cljs.core.nth.call(null,vec__25014,(1),null);
...
var G__25017 = (arity + (1));
var G__25018 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25019){
var vec__25020 = p__25019;
var arity = cljs.core.nth.call(null,vec__25020,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25020,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25023_SHARP_){
return cljs.core.get.call(null,arities,p1__25023_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__25024_SHARP_){
return cljs.core.drop.call(null,(2),p1__25024_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25027){
var vec__25028 = p__25027;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25028,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25025){
var G__25026 = cljs.core.first.call(null,seq25025);
var seq25025__$1 = cljs.core.next.call(null,seq25025);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25026,seq25025__$1);
}));
...
var G__25034 = arg;
var G__25034__$1 = (((G__25034 instanceof cljs.core.Keyword))?G__25034.fqn:null);
switch (G__25034__$1) {
...
var map__25036__$1 = (((((!((map__25036 == null))))?(((((map__25036.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25036.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25036):map__25036);
var include_ns_QMARK_ = cljs.core.get.call(null,map__25036__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25036__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25036__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25036__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25037 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25037,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25037,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25037,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25037,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25037,(4),null);
var arity = cljs.core.nth.call(null,vec__25037,(5),null);
...
var o__24312__auto__ = f;
return (o__24312__auto__["getBasis"]).call(o__24312__auto__);
});
/**
...
}catch (e25041){var _e__24319__auto__ = e25041;
...
var G__25042 = (obj[cljs.core.first.call(null,path)]);
var G__25043 = cljs.core.rest.call(null,path);
obj = G__25042;
path = G__25043;
continue;
} else {
...
var _STAR_ = (function (accum,p__25044){
var vec__25045 = p__25044;
var bit = cljs.core.nth.call(null,vec__25045,(0),null);
var protocol = cljs.core.nth.call(null,vec__25045,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25048){
var vec__25049 = p__25048;
var ns = cljs.core.nth.call(null,vec__25049,(0),null);
var name = cljs.core.nth.call(null,vec__25049,(1),null);
var selector = cljs.core.nth.call(null,vec__25049,(2),null);
...
var post_process = (function (p__25053){
var vec__25054 = p__25053;
var munged_name = cljs.core.nth.call(null,vec__25054,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25054,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__25052_SHARP_){
return (obj[cljs.core.first.call(null,p1__25052_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1607206817711
