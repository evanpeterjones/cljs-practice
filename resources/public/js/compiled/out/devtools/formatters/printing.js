...
var len__4736__auto___25061 = arguments.length;
var i__4737__auto___25062 = (0);
while(true){
if((i__4737__auto___25062 < len__4736__auto___25061)){
args__4742__auto__.push((arguments[i__4737__auto___25062]));

var G__25063 = (i__4737__auto___25062 + (1));
i__4737__auto___25062 = G__25063;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq25058){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25059,G__25060,seq25058__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__25064_SHARP_){
return (!((cljs.core.meta.call(null,p1__25064_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__25065__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e25069){var _e__24292__auto__ = e25069;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e25071){var _e__24292__auto__ = e25071;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__25073 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__25074 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__25074);

try{var map__25075 = opts;
...
var markup_db = cljs.core.get.call(null,map__25075__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__25073);
}});
...
var temp__5718__auto___25080 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___25080)){
var managed_print_level_25081 = temp__5718__auto___25080;
var _STAR_print_level_STAR__orig_val__25078_25082 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__25079_25083 = managed_print_level_25081;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__25079_25083);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__25077_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__25077_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__25078_25082);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1605638683193
