...
var o32694 = temp__5718__auto__;
var temp__5718__auto____$1 = (o32694["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o32695 = temp__5718__auto____$1;
return (o32695["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__32461__auto__ = f;
return (o__32461__auto__["toString"]).call(o__32461__auto__);
} else {
return "";
}
}catch (e32696){var _ = e32696;
return "";
}});
...
try{var o__32461__auto___32698 = t;
(o__32461__auto___32698["cljs$lang$ctorPrWriter"]).call(o__32461__auto___32698,t,writer);
}catch (e32697){var __32699 = e32697;
}
...
var char_code = (function (){var o__32461__auto__ = (new String(char$));
return (o__32461__auto__["charCodeAt"]).call(o__32461__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__32461__auto__ = String;
return (o__32461__auto__["fromCharCode"]).call(o__32461__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__32700 = num_code;
switch (G__32700) {
case (1):
return (185);
...
var o__32461__auto__ = String;
return (o__32461__auto__["fromCharCode"]).call(o__32461__auto__,superscript_code);
});
/**
...
}catch (e32702){var _e__32468__auto__ = e32702;
return false;
}})())){
...
var vec__32703 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__32703,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o32706 = temp__5718__auto__;
var temp__5718__auto____$1 = (o32706["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o32707 = temp__5718__auto____$1;
return (o32707["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__32710){
var vec__32711 = p__32710;
var ns_detector = cljs.core.nth.call(null,vec__32711,(0),null);
...
var G__32717 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__32718 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__32717;
remaining_tokens = G__32718;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq32708){
var G__32709 = cljs.core.first.call(null,seq32708);
var seq32708__$1 = cljs.core.next.call(null,seq32708);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32709,seq32708__$1);
}));
...
var vec__32722 = cljs.core.split_with.call(null,(function (p1__32721_SHARP_){
return cljs.core.not_EQ_.call(null,p1__32721_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__32722,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__32722,(1),null);
...
var vec__32728 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__32728,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__32728,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__32731 = cljs.core.rest.call(null,remaining_tokens);
var G__32732 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__32731;
name_tokens = G__32732;
continue;
} else {
...
var vec__32735 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__32735,(0),null);
var arity = cljs.core.nth.call(null,vec__32735,(1),null);
var vec__32738 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__32738,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__32738,(1),null);
var vec__32741 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__32741,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__32741,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__32741,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__32741,(3),null);
...
var vec__32747 = result;
var munged_ns = cljs.core.nth.call(null,vec__32747,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__32747,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__32747,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__32747,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__32747,(4),null);
var arity = cljs.core.nth.call(null,vec__32747,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__32751 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__32751,(0),null);
var args = cljs.core.nth.call(null,vec__32751,(1),null);
var vec__32754 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__32754,(0),null);
var name = cljs.core.nth.call(null,vec__32754,(1),null);
...
var G__32757 = (arity + (1));
var G__32758 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__32759){
var vec__32760 = p__32759;
var arity = cljs.core.nth.call(null,vec__32760,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__32760,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__32763_SHARP_){
return cljs.core.get.call(null,arities,p1__32763_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__32764_SHARP_){
return cljs.core.drop.call(null,(2),p1__32764_SHARP_);
}),sorted_infos);
...
var G__32773 = (i__4737__auto___32772 + (1));
i__4737__auto___32772 = G__32773;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__32767){
var vec__32768 = p__32767;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__32768,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq32765){
var G__32766 = cljs.core.first.call(null,seq32765);
var seq32765__$1 = cljs.core.next.call(null,seq32765);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32766,seq32765__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__32776__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__32776__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__32776__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__32776__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__32777 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__32777,(0),null);
var fn_name = cljs.core.nth.call(null,vec__32777,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__32777,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__32777,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__32777,(4),null);
var arity = cljs.core.nth.call(null,vec__32777,(5),null);
...
var o__32461__auto__ = f;
return (o__32461__auto__["getBasis"]).call(o__32461__auto__);
});
/**
...
}catch (e32781){var _e__32468__auto__ = e32781;
...
var G__32782 = (obj[cljs.core.first.call(null,path)]);
var G__32783 = cljs.core.rest.call(null,path);
obj = G__32782;
path = G__32783;
continue;
} else {
...
var _STAR_ = (function (accum,p__32784){
var vec__32785 = p__32784;
var bit = cljs.core.nth.call(null,vec__32785,(0),null);
var protocol = cljs.core.nth.call(null,vec__32785,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__32788){
var vec__32789 = p__32788;
var ns = cljs.core.nth.call(null,vec__32789,(0),null);
var name = cljs.core.nth.call(null,vec__32789,(1),null);
var selector = cljs.core.nth.call(null,vec__32789,(2),null);
...
var post_process = (function (p__32793){
var vec__32794 = p__32793;
var munged_name = cljs.core.nth.call(null,vec__32794,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__32794,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__32792_SHARP_){
return (obj[cljs.core.first.call(null,p1__32792_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1607284880927
